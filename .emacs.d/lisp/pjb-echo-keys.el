...
;;;;**************************************************************************
(require 'cl) ; include common-lisp language elements

(defvar *echo-keys-last* nil "Last command processed by `echo-keys'.") ; define variables, initialize, and document
...
(defun echo-keys ()
  (let ((deactivate-mark deactivate-mark)
    ...
    (when keys
      (save-excursion ;; save current position and return when done.
